...
public class NanoAPITest {
    ...
    public void shouldSendRequestAndReceiveResponse() throws JsonProcessingException {
        ...
        // when
        BalanceResponse response = nanoAPI.execute(REQUEST, BalanceResponse.class);

        // then
        BalanceResponse expectedResponse = new BalanceResponse(new BigInteger("10000"), new BigInteger("10000"));
    ...
    public void shouldThrowExceptionWhenServerReurnError() {
        ...
        // when
        nanoAPI.execute(REQUEST, BalanceResponse.class);
    }
